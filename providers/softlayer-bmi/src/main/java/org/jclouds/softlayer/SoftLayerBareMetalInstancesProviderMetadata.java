...
public class SoftLayerBareMetalInstancesProviderMetadata extends BaseProviderMetadata {
   ...
   public static Properties defaultProperties() {
      ...
      properties.setProperty(PROPERTY_SOFTLAYER_BARE_METAL_INSTANCES_ACTIVE_TRANSACTIONS_ENDED_DELAY, "" + 10 * 60 * 60 * 1000);
      properties.setProperty(PROPERTY_SOFTLAYER_BARE_METAL_INSTANCES_ACTIVE_TRANSACTIONS_STARTED_DELAY, "" + 10 * 60 * 60 * 1000);
