 ...
 */
@Test(groups = "live")
public class BaseSoftLayerBareMetalInstancesClientLiveTest extends BaseApiLiveTest<SoftLayerBareMetalInstancesClient> {

   public BaseSoftLayerBareMetalInstancesClientLiveTest() {
      this.provider = "softlayer-bmi";
   }
